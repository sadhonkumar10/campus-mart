      ...
      <div className="navbar px-6 md:px-10 flex justify-between items-center h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="md:hidden">
            {menuOpen ? (
              <HiX className="text-3xl text-gray-700 cursor-pointer" onClick={() => setMenuOpen(false)} />
            ) : (
              <HiOutlineMenu className="text-3xl text-gray-700 cursor-pointer" onClick={() => setMenuOpen(true)} />
            )}
          </div>
